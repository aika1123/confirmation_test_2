...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $kiwi->seasons()->attach(
            Season::WhereIn('name',['秋', '冬'])->pluck('id')
        );
        ...
        $strawberry->seasons()->attach(
            Season::WhereIn('name',['春'])->pluck('id')
        );
        ...
        $orange->seasons()->attach(
            Season::WhereIn('name',['冬'])->pluck('id')
        );
        ...
        $watermelon->seasons()->attach(
            Season::WhereIn('name',['夏'])->pluck('id')
        );
        ...
        $muscat->seasons()->attach(
            Season::WhereIn('name',['夏', '秋'])->pluck('id')
        );
        ...
        $pineapple->seasons()->attach(
            Season::WhereIn('name',['春', '夏'])->pluck('id')
        );
